...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        conv2 = self.drop2(self.pool(F.elu(self.conv2(self.bn2(conv1)))))
        conv3 = self.drop3(self.pool(F.elu(self.conv3(self.bn3(conv2)))))
        conv4 = self.drop4(self.pool(F.elu(self.conv4(self.bn4(conv3)))))
